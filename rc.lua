-- {{{ License
--
-- Origional setup by Adrian - addopted by Aaron for awesome awesoming
...
-- Beautiful theme
beautiful.init(home .. "/.config/awesome/inkpot.lua")
...
batwidget:buttons(awful.util.table.join(
  awful.button({ }, 1, function () exec("xbacklight") end)
))
-- Register widget
...
vicious.register(fs.b, vicious.widgets.fs, "${/usr used_p}",  599)
vicious.register(fs.s, vicious.widgets.fs, "${/tmp used_p}", 599)
vicious.register(fs.b, vicious.widgets.fs, "${/var used_p}",  599)
...
-- Register widget
vicious.register(mailwidget, vicious.widgets.mdir, "$1", 181, { "/home/" .. user .. "/Maildir", 15})
-- Register buttons
mailwidget:buttons(awful.util.table.join(
  --awful.button({ }, 1, function () exec("urxvt -T Alpine -e alpine.exp") end)
  awful.button({ }, 1, function () exec("urxvt -T Mail -e mutt") end)
))
-- }}}
...
datewidget:buttons(awful.util.table.join(
  awful.button({ }, 1, function () exec("iceowl") end)
))
-- }}}
...
globalkeys = awful.util.table.join(
    -- {{{ Applications
    awful.key({ modkey }, "b", function () exec("google-chrome") end),
    awful.key({ modkey }, "p", function () exec("pidgin") end),
